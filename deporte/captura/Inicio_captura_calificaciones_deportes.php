	...
	<body class="left-sidebar is-preload">
				...
				<div class="container">
					<div class="row gtr-200">
						...
						<div class="col-7 col-12-mobile imp-mobile" id="content">
							<article id="main">
								<form id="form1" name="form1" method="post" action="captura_calificacion_primaria_deporte.php" onSubmit = "return validar(this)" enctype='multipart/form-data'>
									<?php
										...
										if(isset($calificacion)){
											...
											echo "<tr><td><label>GRUPO</label></td><td><select name='Grado' id='Grado' onChange='activar1(this.form)' style='width: auto;'>";
											...
											echo "</select></td>";
											echo "</tr>
												<tr><td><label id='deportes'>DEPORTE</label></td>
												<td><select name='deporte' id='deporte' style='width: auto;'>	
		...
		<script type="text/javascript"> 
			function activar1(elemento){ 
				if(elemento.Grado.options[elemento.Grado.selectedIndex].text=='5A' || elemento.Grado.options[elemento.Grado.selectedIndex].text=='5B'|| elemento.Grado.options[elemento.Grado.selectedIndex].text=='6A' || elemento.Grado.options[elemento.Grado.selectedIndex].text=='6B'){
					document.getElementById("deportes").style.display = "inline";  
					document.getElementById("deporte").style.display = "inline"; 
				}
				else{ 
