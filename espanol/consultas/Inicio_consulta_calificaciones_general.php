	...
	<body class="left-sidebar is-preload">
		<div id="page-wrapper">
			...
			<div id="header">
				...
				<nav id="nav">
					<ul>
						<li><a href="../../index.php"><img src="../../estilo/images/home.png" width="20px" height="20px"/></a></a></li>
				...
				<div class="container">
					<div class="row gtr-200">
						...
						<div class="col-7 col-12-mobile imp-mobile" id="content">
							<article id="main">
								<form id="form1" name="form1" method="GET" action="consulta_calificacion_primaria_general.php" onSubmit = "return validar(this)" enctype='multipart/form-data'>
									<center>
										<table>
											<?php
