				...
				<div class="container">
					<div class="row gtr-200">
						<div class="col-3 col-12-mobile" id="sidebar">
							...
							<section>
								<header>
									<h3><a>Registro Periodo de Calificaciones</a></h3>
								</header>
							</section>
						</div>
						<div class="col-7 col-12-mobile imp-mobile" id="content">
							<article id="main">
								<form id="form1" name="form1" method="post" action="captura_periodo_calificaciones.php" onSubmit = "return validar(this)" enctype='multipart/form-data'>
									<?php
										echo "<center>
												<table>";
