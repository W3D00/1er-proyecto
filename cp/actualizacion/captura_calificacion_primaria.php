							...
							if(count($bloqueo) != 0){
								...
								while ($damefila=mysqli_fetch_object($result)){ 
									...
									echo"
										...
										<center><input style='font-size:14px; font-family: arial' type='text' name='cese[$num_fila]' id='cese[$num_fila]' value='".$evidencias[$i][4]."' maxlength='5' size='5' readonly/></center></td>
