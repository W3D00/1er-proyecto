				...
				<div class="container">
					<div class="row gtr-200">
						...
						<div class="col-7 col-12-mobile imp-mobile" id="content">
							<article id="main">
								<form id="form1" name="form1" method="post" action="captura_calificacion_primaria_club.php" onSubmit = "return validar(this)" enctype='multipart/form-data'>
									<?php
										...
										if(isset($calificacion)){
											...
											echo "<select name='Grado' id='Grado' style='width: auto;' type='text'>";
											...
											echo "</select>
												...
												<td>
													<select name='Taller' id='Taller' style='width: auto;' type='text'>
		...
		<script language="JavaScript" type="text/JavaScript">
			$(document).ready(function(){
				$("#Grado").change(function(event){
					...
					$("#Taller").load('../../genera/genera-select17.php?id='+id);
				});
			});
		</script>
		<!----------------------------------scrip validaciones-------------------->
