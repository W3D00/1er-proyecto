<?php
	...
	if(isset($_SESSION['userid'])){
		...
		$porciones = explode("-", $_POST['Taller']);
		$_SESSION["taller"]=$porciones[0];
		$_SESSION["artes"]=$porciones[1];
		
		$con1= mysqli_query($conexion,"SELECT artes.nombre FROM artes WHERE artes.id = '".$_SESSION["artes"]."'") or die(mysqli_error($conexion));							
		$row = mysqli_fetch_array($con1,MYSQLI_ASSOC);
		$nombreartes = $row['nombre'];	
?>
<html>
	<head>
