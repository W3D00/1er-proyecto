				...
				<div class="container">
					<div class="row gtr-200">
						<div class="col-3 col-12-mobile" id="sidebar">
							...
							<section>
								<header>
									<h3><a>ACTUALIZACI&Oacute;N DE CALIFICACIONES</a></h3>
								</header>
							</section>
						</div>
								...
								<form id="form1" name="form1" method="post" action="captura_calificacion_primaria_deporte.php" onSubmit = "return validar(this)" enctype='multipart/form-data'>
									<?php
										...
										if(isset($calificacion)){
											...
											echo "<select name='Grado' id='Grado' onChange='activar1(this.form)' style='width: auto;' type='text'>";
											...
											echo "</select>
												...
												<tr>
												<td><label>EDUCACI&Oacute;N F&Iacute;SICA</label></td>
												<td><select name='Deporte' id='Deporte' style='width: auto;' type='text'>
		...
		<script language="JavaScript" type="text/JavaScript">
			$(document).ready(function(){
				$("#Grado").change(function(event){
					...
					$("#Deporte").load('../../genera/genera-select07.php?id='+id);
				});
			});
		</script>
	</body>
