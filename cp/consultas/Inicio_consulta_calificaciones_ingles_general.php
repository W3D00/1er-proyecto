				...
				<div class="container">
					<div class="row gtr-200">
						...
						<div class="col-7 col-12-mobile imp-mobile" id="content">
							<article id="main">
								<form id="form1" name="form1" method="get" action="consulta_calificacion_primaria_ingles_general.php" onSubmit = "return validar(this)" enctype='multipart/form-data'>
									<center>
										<table>
											<?php
												if($_SESSION['puesto']=='APOYO TECNICO PEDAGOGICO INGLES' || $_SESSION['puesto']=='COORDINADOR'){
