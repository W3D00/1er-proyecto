							...
							if($_SESSION["bloque"] != 0 && $_SESSION["grado"]!= 0){
								...
								echo '<div class="col-8 col-12-mobile imp-mobile" id="content">
										<article id="main">
											<form id="form1">
												<header>
													<h3><a>CONSULTA PROMEDIO ESCOLTA</a></h3>
								...
								for($i=0;$i<count($alumno);$i++){
									...
									$promedio[$i]=bcdiv((($final1[$i]+$final2[$i]+$final3[$i]+$final4[$i])/4), '1', 1);
								}
									...
									if($_SESSION['puesto']=='CONTROL ESCOLAR'){
										...
										echo "<table width=500 align=center> 
											...
											<tr bgcolor='A19F9F' align=center> 
												...
												<td style='border:1px solid white'><center>PROMEDIO</center></td> 
											</tr>";
										...
										while ($damefila=mysqli_fetch_object($result)){ 
											...
											echo"
												...
												<td style='border:1px solid white'><center>".$promedio[$i]."</center></td>
												</tr> ";
